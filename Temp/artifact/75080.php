...
<p>⑭高分子反応</p>
<p>⑮高分子の分解</p>
<p>⑯期末試験</p></div><div style="margin:20px 3px 3px 3px;padding-top:6px;padding-bottom:3px;padding-left:7px;background-color:lightsteelblue">成績評価の方法</div><div style="margin:10px"><p>中間テストと期末試験，レポートを総合して評価する。</p>
<p> </p>
<p><span> </span></p></div><div style="margin:20px 3px 3px 3px;padding-top:6px;padding-bottom:3px;padding-left:7px;background-color:lightsteelblue">成績評価の基準</div><div style="margin:10px">秀　 達成目標を超えた成果を上げている　100点～90点<br>優　 達成目標に十分達している　　　　　89点～80点<br>良　 達成目標に達している　　　　　　　79点～70点<br>可　 達成目標に概ね達している　　　　　69点～60点<br>不可 達成目標に達していない　　　　　　59点以下<br><p>中間テスト（配点40点）</p>
<p>講義①～⑦までの内容の理解度を評価する。</p>
<p>期末試験（配点40点）</p>
<p>講義⑨～⑮までの内容の理解度を評価する。</p>
<p>レポート（配点20点）</p>
<p> 中間試験と期末試験，レポートの合計得点が６０点以上を合格とする。</p>
<p> 成績評価の基準:</p>
...
<p> </p>
<div><a>事前にメールで連絡ください。(</a><a>matsuoka.shinichi@nitech.ac.jp</a><a>)</a></div></div></td></tr></table><p><span style="background-color:#ffffff;"><a href="https://cms7.ict.nitech.ac.jp/moodle40a/syllabus/search.php">検索 に戻る</a></span><p></center>