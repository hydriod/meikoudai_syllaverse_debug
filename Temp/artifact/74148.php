...
<div>効率のよいプログラムを書くためには，データ構造とアルゴリズムに関する知識が不可欠である．この授業では，さまざまな処理を効率的に行うための基本的なデータ構造およびアルゴリズムの解析法と設計法を修得することを目的とする．</div>
<p> </p>
...
<div>13. 計算困難性の基本を理解し，説明できる．</div>
<div> </div></div><div style="margin:20px 3px 3px 3px;padding-top:6px;padding-bottom:3px;padding-left:7px;background-color:lightsteelblue">授業計画</div><div style="margin:10px"><div>  1. アルゴリズムの重要性と効率性の評価尺度</div>
...
<div>  8. 中間試験・講評</div>
<div>  9. グラフアルゴリズム(１)（グラフの表現、探索）</div>
<div>10. グラフアルゴリズム(２)（幅優先，深さ優先探索の応用）</div>
<div>11. グラフアルゴリズム(３)（ダイクストラ法）</div>
<div>12. グラフアルゴリズム(４)（MST）</div>
<div>13. 近似アルゴリズム（TSP，2-Opt法，焼きなまし法，分枝限定法）</div>
<div>14. <span>計算困難性（NP）</span></div>
<div>15. 期末試験・講評</div>
<div> </div>
<div>注意：授業実施状況に応じて，中間試験を総合演習などに代える可能性があります．</div></div><div style="margin:20px 3px 3px 3px;padding-top:6px;padding-bottom:3px;padding-left:7px;background-color:lightsteelblue">成績評価の方法</div><div style="margin:10px"><p><span>試験，各時間に行うミニレポートにより判断する．</span></p>
...
<p><span><span>事前学修：moodle上の授業資料及び教科書による予習（120分）</span><br /><span>事後学修：授業後に実施するレポート課題を中心に，受講日のうちに授業内容について教科書の演習問題や授業資料等で復習（120分）</span></span></p></div><div style="margin:20px 3px 3px 3px;padding-top:6px;padding-bottom:3px;padding-left:7px;background-color:lightsteelblue">教科書</div><div style="margin:10px">IT Textアルゴリズム論 浅野，和田，増澤著（オーム社）<br></div><div style="margin:20px 3px 3px 3px;padding-top:6px;padding-bottom:3px;padding-left:7px;background-color:lightsteelblue">参考書</div><div style="margin:10px">アルゴリズムイントロダクションⅠ,Ⅱ,Ⅲ　コルメン，リベスト，ライザーソン著（近代科学社）<br>アルゴリズムデザイン　Kleinberg, Tardos著（共立出版）<br></div><div style="margin:20px 3px 3px 3px;padding-top:6px;padding-bottom:3px;padding-left:7px;background-color:lightsteelblue">オフィスアワー</div><div style="margin:10px"><p>随時受け付ける．ただし、事前に電子メール等で連絡すること．</p>
<p>メールアドレス: kawa1983@nitech.ac.jp</p></div></td></tr></table><p><span style="background-color:#ffffff;"><a href="https://cms7.ict.nitech.ac.jp/moodle40a/syllabus/search.php">検索 に戻る</a></span><p></center>